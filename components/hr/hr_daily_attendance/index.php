...
if (isset($_SESSION["username"]) && isset($_SESSION["user_id"]) && isset($_SESSION["schoolDirectory"]) && $_SESSION["schoolDirectory"] == 'School') {
	$check_module_permission = check_module_permission_user($db, $conn, "hr_daily_attendance", $_SESSION["user_id"], $_SESSION["school_admin_id"], $_SESSION["user_type"], $_SESSION["db_name"]);
	if ($check_module_permission == "") {
		...
		if (isset($_POST['type']) && $_POST['type'] == 'update') {
			...
			$sql_c_up = "UPDATE " . $selected_db_name . ".emp_attendance SET enabled 		= '" . $new_status . "',
