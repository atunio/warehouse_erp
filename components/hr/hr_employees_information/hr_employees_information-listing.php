			...
			<div class="container">
				<div class="row">
					...
					<div class="col s2 m6 l6">
						<a class="btn waves-effect waves-light green darken-1 breadcrumbs-btn right" href="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=add_edit&cmd=add&active_tab=tab1") ?>" data-target="dropdown1">
							Add New
						</a>
					</div>
				</div>
