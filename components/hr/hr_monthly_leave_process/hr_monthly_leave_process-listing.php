...
$sql_cl 		= "	SELECT a.*
					FROM " . $selected_db_name . ".hr_leaves_process_entries a
					WHERE a.school_admin_id = '" . $school_admin_id . "'
					ORDER BY a.leave_process_year DESC, a.leave_process_month "; //echo $sql_cl;
$result_cl 		= $db->query($conn, $sql_cl);
$count_cl 		= $db->counter($result_cl);
$page_heading = "Monthly Leave Process ";
													...
													if ($count_cl > 0) {
														...
														foreach ($row_cl as $data) {
															...
															<tr data-id="<?php echo $id; ?>">
																<td><?php echo $i + 1; ?></td>
																<td><?php echo $data['leave_process_year']; ?></td>
																<td><?php echo convert_month_letter($data['leave_process_month']); ?></td>
																<td><?php echo $data['casual_leaves']; ?></td>
																<td><?php echo $data['sick_leaves']; ?></td>
																<td><?php echo $data['casual_leaves'] + $data['sick_leaves']; ?></td>
