...
$sql_cl 		= "	SELECT a.*
					FROM " . $selected_db_name . ".off_days_school a
					WHERE a.school_admin_id = '" . $school_admin_id . "'
					ORDER BY a.enabled DESC, a.off_day_name "; //echo $sql_cl;
$result_cl 		= $db->query($conn, $sql_cl);
$count_cl 		= $db->counter($result_cl);
$page_heading = "Paid Off Days"; ?>
<!-- BEGIN: Page Main-->
						...
						<div class="col s12">
							<div class="card">
								<div class="card-content">
									...
									<div class="row">
										<div class="col s12">
											<table id="page-length-option" class="display  slider_image_table">
												<thead>
													<tr>
														<th width="5%">S.No</th>
														<th>Paid Off Day</th>
													...
													if ($count_cl > 0) {
														...
														foreach ($row_cl as $data) {
															...
															<tr data-id="<?php echo $id; ?>">
																<td><?php echo $i + 1; ?></td>
																<td><?php echo $data['off_day_name']; ?></td>
																<td class="text-align-center">
																	<a href="javascript:void(0)" onclick="change_status(this,'<?php echo $id ?>')"><?php echo ($data['enabled'] == '1') ? 'Enable' : 'Disable'; ?></a>
																	&nbsp;&nbsp;
