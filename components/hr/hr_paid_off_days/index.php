...
if(isset($_SESSION["username"]) && isset($_SESSION["user_id"]) && isset($_SESSION["schoolDirectory"]) && $_SESSION["schoolDirectory"] == 'School'){
	$check_module_permission = check_module_permission_user($db, $conn, "hr_paid_off_days", $_SESSION["user_id"], $_SESSION["school_admin_id"], $_SESSION["user_type"], $_SESSION["db_name"]);
	if($check_module_permission == ""){
		...
		if(isset($_POST['type']) && $_POST['type'] == 'update'){ 
			...
			$sql_c_up = "UPDATE ".$selected_db_name.".off_days_school SET 	enabled 		= '".$new_status."',
