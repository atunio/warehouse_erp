...
$sql_cl 		= "	SELECT  a.* FROM defect_codes a ORDER BY a.enabled DESC, a.id DESC  "; // echo $sql_cl;
								...
								<div class="card-content custom_padding_card_content_table_top">
									...
									<div class="row">
										<div class="text_align_right">
											<?php 
											$table_columns	= array('SNo', 'Defect Code','Actions');
											$k 				= 0;
													...
													if ($count_cl > 0) {
														...
														foreach ($row_cl as $data) {
															...
															<tr>
																...
																<td class="col-<?= set_table_headings($table_columns[1]);?>"><?php echo ucwords(strtolower($data['defect_code'])); ?></td>
