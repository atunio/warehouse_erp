...
$sql_cl 		= "	SELECT  a.* FROM phone_check_users a ORDER BY a.enabled DESC, a.id DESC  "; // echo $sql_cl;
								...
								<div class="card-content custom_padding_card_content_table_top">
									...
									<div class="row">
										<div class="text_align_right">
											<?php 
											$table_columns	= array('SNo', 'Username', 'Full Name','Actions');
											$k 				= 0;
													...
													if ($count_cl > 0) {
														...
														foreach ($row_cl as $data) {
															...
															<tr>
																...
																<td class="col-<?= set_table_headings($table_columns[1]);?>"><?php echo (($data['username'])); ?></td>
																<td class="col-<?= set_table_headings($table_columns[1]);?>"><?php echo ucwords(strtolower($data['full_name'])); ?></td>
