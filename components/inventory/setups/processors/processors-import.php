...
$supported_column_titles 	= array("processor_name");
$duplication_columns 		= array("processor_name");
$required_columns 			= array("processor_name");
	...
	if (empty($error)) {
		...
		if (isset($all_data) && sizeof($all_data) > 0) {
			...
			foreach ($all_data  as $data1) {
				if (isset($data1['processor_name']) && $data1['processor_name'] != '' && $data1['processor_name'] != NULL && $data1['processor_name'] != 'blank') {
					$processor_name2 	= $data1['processor_name'];
					...
					if (isset($ids_already) && isset($processor_name2) && in_array($processor_name2, $ids_already)) {
						if ($update_column != "") { // ONLY IF one field 
							$sql6 = "UPDATE " . $selected_db_name . "." . $master_table . " SET update_date 			= '" . $add_date . "', 
																								...
																								" . $update_column . "
									WHERE processor_name 	= '" . $processor_name2 . "' "; //echo "<br><br>".$sql6;
