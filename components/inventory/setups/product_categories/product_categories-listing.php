	...
	if (isset($is_Submit_del) && $is_Submit_del == 'Y') {
		...
		if (empty($error)) {
			...
			foreach ($record_ids as $data_d) {
				if ($is_enabled != "") {
					$sql_dl = "UPDATE product_categories SET enabled = '" . $is_enabled . "' WHERE id = '" . $data_d . "' ";
														...
														foreach ($row_cl as $data) {
															...
															<tr>
																...
																<td class="col-<?= set_table_headings($table_columns[$column_no]); ?>">
																	<?php
																	if ($data['category_name'] != "No Category") { ?>
																		<label>
																	...
																	if ($data['category_name'] != "") {
																		echo ucwords(strtolower($data['category_name']));
																	}
																	$column_no++; ?>
																</td>
																<td class="col-<?= set_table_headings($table_columns[$column_no]); ?>">
																	...
																	if ($data['category_type'] != "") {
																		echo ucwords(strtolower($data['category_type']));
																	}
																	$column_no++; ?>
																</td>
