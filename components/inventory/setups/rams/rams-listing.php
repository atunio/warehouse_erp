...
$sql_cl 		= "	SELECT  a.* FROM rams a ORDER BY a.enabled DESC, a.id DESC  "; // echo $sql_cl;
												...
												if ($count_cl > 0) {
													...
													foreach ($row_cl as $data) {
														...
														<tr>
															...
															<td class="col-<?= set_table_headings($table_columns[1]);?>"><?php echo ucwords(strtolower($data['ram_name'])); ?></td>
