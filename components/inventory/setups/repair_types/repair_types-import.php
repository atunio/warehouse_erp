...
$supported_column_titles 	= array("repair_type_name");
$duplication_columns 		= array("repair_type_name");
$required_columns 			= array("repair_type_name");
	...
	if (empty($error)) {
		...
		if (isset($all_data) && sizeof($all_data) > 0) {
			...
			foreach ($all_data  as $data1) { 
				if (isset($data1['repair_type_name']) && $data1['repair_type_name'] != '' && $data1['repair_type_name'] != NULL && $data1['repair_type_name'] != 'blank') {
					$repair_type_name2 	= $data1['repair_type_name'];
					...
					if(isset($ids_already) && isset($repair_type_name2) && in_array($repair_type_name2, $ids_already)){
						if ($update_column != "" ) { // ONLY IF one field 
							$sql6 = "UPDATE " . $selected_db_name . "." . $master_table . " SET update_date 			= '" . $add_date . "', 
																								...
																								".$update_column."
									WHERE repair_type_name 	= '".$repair_type_name2."' "; //echo "<br><br>".$sql6;
