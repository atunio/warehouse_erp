					...
					<form method="post" autocomplete="off">
						...
						<div class="row">
							<div class="input-field col m4 s12">
								...
								$field_name 	= "purpose";
								$field_label 	= "Purpose";
								$sql1 			= "SELECT * FROM sub_location_purposes WHERE enabled = 1 ORDER BY sub_location_purpose_name ";
								$result1 		= $db->query($conn, $sql1);
								$count1 		= $db->counter($result1);
								?>
								<i class="material-icons prefix">question_answer</i>
								<div class="select2div">
									<select id="<?= $field_name; ?>" name="<?= $field_name; ?>" class=" select2 browser-default select2-hidden-accessible validate <?php if (isset(${$field_name . "_valid"})) {
										...
										if ($count1 > 0) {
											$row1	= $db->fetch($result1);
											foreach ($row1 as $data2) { ?>
												<option value="<?php echo $data2['sub_location_purpose_name']; ?>" <?php if (isset(${$field_name}) && ${$field_name} == $data2['sub_location_purpose_name']) { ?> selected="selected" <?php } ?>><?php echo $data2['sub_location_purpose_name']; ?></option>
										<?php }
										} ?>
									</select>
									<label for="<?= $field_name; ?>">
							...
							<div class="input-field col m4 s12">
								...
								$field_label 	= "Type";
								$sql1 			= "SELECT * FROM sub_location_types WHERE enabled = 1 ORDER BY sub_location_type_name ";
								$result1 		= $db->query($conn, $sql1);
								$count1 		= $db->counter($result1);
								?>
								<i class="material-icons prefix">question_answer</i>
								<div class="select2div">
									<select id="<?= $field_name; ?>" name="<?= $field_name; ?>" class=" select2 browser-default select2-hidden-accessible validate <?php if (isset(${$field_name . "_valid"})) {
										...
										if ($count1 > 0) {
											$row1	= $db->fetch($result1);
											foreach ($row1 as $data2) { ?>
												<option value="<?php echo $data2['sub_location_type_name']; ?>" <?php if (isset(${$field_name}) && ${$field_name} == $data2['sub_location_type_name']) { ?> selected="selected" <?php } ?>><?php echo $data2['sub_location_type_name']; ?></option>
										<?php }
										} ?>
									</select>
									<label for="<?= $field_name; ?>">
