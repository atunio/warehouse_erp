			...
			foreach ($all_data  as $data1) {
				...
				if (!in_array($data1[$dup_data], $duplicate_data_array)) {
					...
					if ($columns != "" && $column_data != "") { // ONLY IF one field 
						$sql6 = "INSERT INTO " . $selected_db_name . "." . $master_table . "(warehouse_id, subscriber_users_id " . $columns . ", add_date, add_by, add_ip)
								VALUES(1, '" . $subscriber_users_id . "' " . $column_data . ", '" . $add_date . "', '" . $_SESSION['username'] . "', '" . $add_ip . "')";
						//echo "<br>" . $sql6;
