...
$sql_cl 		= "	SELECT  a.*, b.warehouse_name
					...
					WHERE 1=1 "; // echo $sql_cl;
if (isset($flt_sub_location) && $flt_sub_location != "") {
	$sql_cl 	.= " AND a.id = '" . trim($flt_sub_location) . "' ";
}
									...
									<div class="row">
										<div class="input-field col m3 s12">
											...
											<div class="select2div">
												<?php
												$field_name     = "flt_sub_location";
												$field_label    = "Bin/Location";

												$sql1           = " SELECT * FROM warehouse_sub_locations ORDER BY enabled desc, id ASC";
