										...
										<div class="row">
											<div class="col s12">
												<div class="yearly-revenue-chart">
													...
													<canvas id="thisYearRevenue" class="firstShadow chartjs-render-monitor" height="350" style="display: block;" width="992"></canvas>
													<canvas id="lastYearRevenue" height="350" width="992" style="display: block;" class="chartjs-render-monitor"></canvas>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col s12 m4 l4">
								<div id="weekly-earning" class="card animate fadeUp">
									<div class="card-content">
										...
										<canvas id="monthlyEarning" class="chartjs-render-monitor" height="150" width="461" style="display: block; width: 461px; height: 150px;"></canvas>
							...
							<div class="col s12 m4 l4">
								<div class="card pt-0 pb-0 animate fadeLeft">
									...
									<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
										...
										<canvas id="custom-line-chart-sample-one" class="center chartjs-render-monitor" width="509" height="254" style="display: block; width: 509px; height: 254px;"></canvas>
									</div>
								</div>
							</div>
							<div class="col s12 m4 l4 animate fadeUp">
								<div class="card pt-0 pb-0">
									...
									<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
										...
										<canvas id="custom-line-chart-sample-two" class="center chartjs-render-monitor" width="509" height="254" style="display: block; width: 509px; height: 254px;"></canvas>
									</div>
								</div>
							</div>
							<div class="col s12 m4 l4">
								<div class="card pt-0 pb-0 animate fadeRight">
									...
									<div class="sample-chart-wrapper" style="margin-bottom: -14px; margin-top: -75px;">
										...
										<canvas id="custom-line-chart-sample-three" class="center chartjs-render-monitor" width="509" height="254" style="display: block; width: 509px; height: 254px;"></canvas>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="slide-out-right-body row pl-3 ps ps--active-y">
								...
								<div class="ps__rail-y" style="top: 0px; height: 869px; right: 0px;">
									<div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 597px;"></div>
								</div>
							</div>
						</div>
					</div>
					...
					<ul id="slide-out-chat" class="sidenav slide-out-right-sidenav-chat right-aligned">
						...
						<li class="chat-body">
							<ul class="collection ps ps--active-y">
								...
								<div class="ps__rail-x" style="left: 0px; bottom: -490px;">
									<div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
								</div>
								<div class="ps__rail-y" style="top: 490px; height: 738px; right: 0px;">
									<div class="ps__thumb-y" tabindex="0" style="top: 295px; height: 443px;"></div>
								</div>
							</ul>
						</li>
