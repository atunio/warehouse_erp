			...
			<div class="col s12 m12 l12">
				<div id="Form-advance2" class="card card card-default scrollspy">
					<div class="card-content">
						...
						<form method="post" autocomplete="off" action="<?php echo "?string=" . encrypt('module=' . $module . '&module_id=' . $module_id . '&page=add&cmd=' . $cmd . '&cmd2=' . isset($cmd2) &&  $cmd2 . '&id=' . $id . '&detail_id=' . $detail_id); ?>">
							...
							<div class="row">
								<div class="input-field col m6 s12">
									<?php if ((isset($cmd2) &&  $cmd2 == 'add' && access("add_perm") == 1)  || (isset($cmd2) &&  $cmd2 == 'edit' && access("edit_perm") == 1)) { ?>
								...
								<div class="input-field col m2 s12">
									<?php if (isset($cmd2) &&  $cmd2 == 'edit' && access("add_perm") == 1) { ?>
														...
														if ($count_cl > 0) {
															...
															foreach ($row_cl as $data) {
																...
																<tr>
																	...
																	<td>
																		<?php
																		if ($data['is_tested'] == 'Yes') {
																			echo "<b>Tested, </b>";
																		}
																		if ($data['is_wiped'] == 'Yes') {
																			echo "<b>Wiped, </b>";
																		}
																		if ($data['is_wiped'] == 'Yes') {
																			echo "<b>Imaged</b>";
