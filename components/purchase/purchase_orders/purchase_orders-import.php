			...
			<div class="container">
				<div class="row">
					...
					<div class="col s2 m2 l2">
						<a class="btn waves-effect waves-light blue darken-1 breadcrumbs-btn right" href="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=import_file") ?>" data-target="dropdown1">
							Import File
						</a>
					</div>
					<div class="col s2 m2 l2">
