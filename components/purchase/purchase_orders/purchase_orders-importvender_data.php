...
$supported_column_titles	= array("product_id", "product_category", "serial_no", "overall_grade", "storage", "battery", "memory", "processor", "warranty_days", "price", "defects_or_notes", "status");
$duplication_columns 		= array("serial_no");
$required_columns 			= array("serial_no");
			...
			<div class="container">
				<div class="row">
					...
					<div class="col s2 m6 l6">
						<a class="btn waves-effect waves-light green darken-1 breadcrumbs-btn right" href="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=profile&cmd=edit&cmd2=edit&id=" . $id . "&active_tab=tab4") ?>" data-target="dropdown1">
							PO Profile
						</a>
					</div>
				</div>
