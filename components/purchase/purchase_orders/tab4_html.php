    ...
    <div class="card-panel" style="padding-top: 5px; padding-bottom: 5px;">
        <div class="row">
            <div class="col s10 m12 l8">
                <h5 class="breadcrumbs mt-0 mb-0"><span>Vender's Data</span></h5>
            </div>
        </div>
        <?php
            ...
            <div class="row">
                ...
                <div class="input-field col m4 s12">
                    <?php if (access("add_perm") == 1) { ?>
                        <a class="btn waves-effect waves-light blue darken-1 breadcrumbs-btn right" href="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&id=" . $id . "&page=importvender_data") ?>">
                            Import
                        </a>
                    <?php } ?>
                </div>
