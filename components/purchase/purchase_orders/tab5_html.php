         ...
         <?php
            ...
            if ($count_log > 0) { ?>
                        ...
                        <div class="card-panel custom_padding_card_content_table_top_bottom">
                            ...
                            <div id="receive_as_category_section" style="<?php if (isset($is_Submit_tab5) && $is_Submit_tab5 == 'Y') {;
                                                        ...
                                                        if ($count_r1 > 0) {
                                                            ...
                                                            <tr>
                                                                <td style="width: 400px;">
                                                                    <?php echo $data_r1['product_uniqueid']; ?>
                                                                </td>
                                                                <td style="width: 400px;">
                                                                    <?php
                                ...
                                <div class="row">
                                    <div class="input-field col m12 s12 text_align_center">
                                        <?php if (isset($id) && $id > 0 && (($cmd5 == 'add' || $cmd5 == '') && access("add_perm") == 1)  || ($cmd5 == 'edit' && access("edit_perm") == 1) || ($cmd5 == 'delete' && access("delete_perm") == 1)) { ?>
                                            <button class="btn waves-effect waves-light gradient-45deg-purple-deep-orange" type="submit" name="add">Receive as Category</button>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <form class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&active_tab=tab5") ?>" method="post">
                        ...
                        if ($count_log > 0) { ?>
                            <div class="card-panel custom_padding_card_content_table_top_bottom">
                                <div class="row">
                                    <div class="col m6 s12">
                                        <h5>Receive Package Materials</h5>
                                    </div>
                ...
                $sql            = " SELECT a.*, c.product_desc, c.product_uniqueid, d.category_name, 
                                            e.first_name, e.middle_name, e.last_name, e.username, f.tracking_no, g.sub_location_name, b1.is_pricing_done
                                    FROM purchase_order_detail_receive a
                ...
                if ($count_log > 0) { ?>
                    <div class="card-panel custom_padding_card_content_table_top_bottom" >
                        <div class="row">
                            <div class="col m12 s12">
                                <h5>Location & Category Wise Total</h5>
                            </div>
                        </div>
                        <div class="row">
                            <table class="bordered">
