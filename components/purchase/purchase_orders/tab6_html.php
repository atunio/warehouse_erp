                        ...
                        <div class="row">
                            <div class="col l12 s12">
                                <ul class="tabs tabs-fixed-width tab-demo z-depth-1">
                                    <li class="tab">
                                        <a href="#sub_tab1"> <i class="material-icons">receipt</i>
                                        <span>Master Profile</span></a>
                                    </li>
                                    <li class="tab">
                                        <a href="#sub_tab2"> <i class="material-icons">list</i>
                                        <span>Preview Of all processed devices</span></a>
                                    </li>
                                    <li class="tab">
                                        <a href="#sub_tab3"> <i class="material-icons">attach_money</i>
                                        <span>Price Mapping</span></a>
                                    </li>
                                    <li class="tab">
                                        <a href="#sub_tab4"> <i class="material-icons">list</i>
                                        <span>% of Entire PO</span></a>
                                    </li>
                                </ul>
                            
                                <div id="sub_tab1" style="display: <?php if (isset($active_tab) && $active_tab == 'tab1') {
                                                        echo "block";
                                                    } else {
                                                        echo "none";
                                                    } ?>;">
                                    <?php
                                        ...
                                        if ($count_log > 0) { ?>
                                            <form id="barcodeForm2" class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&assignment_id=" . $assignment_id . "&active_tab=tab6") ?>" method="post">
                                            ...
                                            <form id="serialno" class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&assignment_id=" . $assignment_id . "&active_tab=tab6") ?>" method="post">
                                            ...
                                            <div class="card-panel custom_padding_card_content_table_top_bottom">
                                                ...
                                                <div id="update_tested_devices_serial_from_phonechecker_tab6" style="<?php if (isset($is_Submit_tab6_6) && $is_Submit_tab6_6 == 'Y') {;
                                                    ...
                                                    <form class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&assignment_id=" . $assignment_id . "&active_tab=tab6") ?>" method="post">
                                                    ...
                                                    if (isset($assignment_id) && $assignment_id > 0) {
                                                        ...
                                                        if ($count_preview > 0) {
                                                            ...
                                                            <form method="post" autocomplete="off" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&assignment_id=" . $assignment_id . "&active_tab=tab6") ?>" method="post">
                                            ...
                                            <form id="barcodeForm2_1" class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=" . $page . "&cmd=edit&id=" . $id . "&assignment_id=" . $assignment_id . "&active_tab=tab6") ?>" method="post">
                                ...
                                <div id="sub_tab2" style="display: <?php if (isset($active_tab) && $active_tab == 'tab1') {
                                                        echo "block";
                                                    } else {
                                                        echo "none";
                                                    } ?>;">
                                    <div class="card-panel">
                                        <p>Content for General Sub Tab 2</p>
                                    </div>
                                </div>
                                <div id="sub_tab3" style="display: <?php if (isset($active_tab) && $active_tab == 'tab1') {
                                                        echo "block";
                                                    } else {
                                                        echo "none";
                                                    } ?>;">
                                ...
                                <div id="sub_tab4" style="display: <?php if (isset($active_tab) && $active_tab == 'tab1') {
                                                        echo "block";
                                                    } else {
                                                        echo "none";
                                                    } ?>;">
