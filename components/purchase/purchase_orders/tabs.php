    ...
    <ul class="tabs tabs-fixed-width tab-demo z-depth-1">
        ...
        if (po_permisions("PO Detail") == 1) { ?>
            <li class="tab" id="show_tab1">
                <a href="javascript:void(0)" class="<?php if (isset($active_tab) && $active_tab == 'tab1') {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("Vendor Data") == 1) { ?>
            <li class="tab" id="show_tab4">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab4')) {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("Logistics") == 1) {  ?>
            <li class="tab" id="show_tab2">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab2')) {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("Arrival") == 1) { ?>
            <li class="tab" id="show_tab3">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab3')) {
                                                        echo "active";
                                                    } ?>">
                    <i class="material-icons dp48">add_shopping_cart</i>
                    <span> Arrival
        ...
        if (po_permisions("Receive") == 1) { ?>
            <li class="tab" id="show_tab5">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab5')) {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("Diagnostic") == 1) { ?>
            <li class="tab" id="show_tab6">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab6')) {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("RMA") == 1) { ?>
            <li class="tab" id="show_tab7">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab7')) {
                                                        echo "active";
                                                    } ?>">
        ...
        if (po_permisions("PriceSetup") == 1) { ?>
            <li class="tab" id="show_tab8">
                <a href="javascript:void(0)" class="<?php if (!isset($active_tab) || (isset($active_tab) && $active_tab == 'tab8')) {
                                                        echo "active";
                                                    } ?>">
