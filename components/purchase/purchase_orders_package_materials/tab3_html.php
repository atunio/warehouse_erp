                            ...
                            <div class="row">
                                ...
                                <div class="input-field col m2 s12">
                                    <?php if (isset($id) && $id > 0 && (($cmd3 == 'add' || $cmd3 == '') && access("add_perm") == 1)  || ($cmd3 == 'edit' && access("edit_perm") == 1) || ($cmd3 == 'delete' && access("delete_perm") == 1)) { ?>
                                        <button class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col m12 s12" type="submit" name="add">Receive</button>
                                    <?php } ?>
                                </div>
                                <div class="input-field col m5 s12"></div>
                            </div>
            ...
            <div class="card-panel">
                <div class="row">
                    <div class="col 24 s12"><br>
                        <div class="card-alert card red lighten-5">
                            <div class="card-content red-text">
                                <p>Nothing logistic Inofrmation yet. </p>
                            </div>
                        </div>
                    </div>
                </div>
