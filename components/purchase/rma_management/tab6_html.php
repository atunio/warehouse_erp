                                            ...
                                            if ($count_log > 0) {
                                                ...
                                                foreach ($row_cl1 as $data) {
                                                    ...
                                                    <tr>
                                                        <td style="<?= $td_padding; ?>">
                                                            <?php echo $i + 1;
                                                            if ($serial_no_barcode != "" && $serial_no_barcode != null && po_permisions("Move as Inventory") == 1 && $data['edit_lock'] == "0") { ?>
                                                        ...
                                                        <td style="<?= $td_padding; ?>">
                                                            ...
                                                            if ($serial_no_barcode != "") {
                                                                ///*
                                                                if ($data['phone_check_api_data'] == NULL || $data['phone_check_api_data'] == "" || $data['phone_check_api_data'] == '{"msg":"Failed to get device info results"}') {
                                                                    ...
                                                                    $sql_c_up    = "UPDATE  purchase_order_detail_receive SET	phone_check_api_data	= '" . $jsonData2 . "',
                                                                                                                                ...
                                                                                                                                sub_product_id			= '" . $sub_product_id_r . "',
