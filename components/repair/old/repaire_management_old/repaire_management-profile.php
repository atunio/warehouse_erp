...
if (isset($test_on_local) && $test_on_local == 1) {
	if (isset($cmd) && $cmd != 'edit') {
		$po_id						= "1204";
		$trip_start_on					= "15/12/2022";
		$expense_status_date			= "15/12/2022";
		$paid_date						= "15/12/2022";
		$trip_starts_at					= "1";
		$number_of_days					= "2";
		$trip_ends_at					= "1";
		$staff_id						= "1006";
		$transportation_cost			= "10";
		$no_of_hotel_nights				= "1";
		$total_hotel_cost				= "1";
		$no_of_meal_days				= "1";
		$total_meal_cost				= "1";
		$no_of_sold_days				= "1";
		$no_of_utilized_days			= "1";
		$task_status_id					= "1";
		$no_of_utilized_days			= "1";
		$no_of_utilized_days			= "1";
		$no_of_utilized_days			= "1";
		$no_of_utilized_days			= "1";
		$expense_status_id				= "1";
		$city_trip_starts_at			= "city_trip_starts_at";
		$city_trip_ends_at				= "city_trip_ends_at";
	}

	$time_in_factory = $preparation2 = $communication2 = $work_ethics = $surveyer_comments = $skills = "5";
	$schedule = $preparation = $communication = $behavior = $manager_comments = $report = "6";
}
if (!isset($module)) {
...
$button_val = "Create";
if (isset($cmd) && $cmd == 'edit') {
	$title_heading = $main_menu_name . " Detail";
	$button_val = "Update";
}
if (!isset($cmd)) {
	$title_heading 	= "Create " . $main_menu_name;
	$button_val = "Create";
}
