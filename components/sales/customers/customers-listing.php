...
$sql_cl 		= "	SELECT a.* FROM customers a WHERE 1=1  "; 
if (isset($flt_customer) && $flt_customer != "") {
	$sql_cl 	.= " AND a.id = '" . trim($flt_customer) . "' ";
}
									...
									<form method="post" autocomplete="off" enctype="multipart/form-data"  action="<?php echo "?string=" . encrypt('module_id=' . $module_id . '&page=' . $page); ?>">
										...
										<div class="row">
											<div class="input-field col m2 s12">
												<?php
												$field_name 	= "flt_customer";
												$field_label 	= "Customer";
												$sql1 			= "SELECT a.* FROM customers a  ORDER BY customer_name ";
