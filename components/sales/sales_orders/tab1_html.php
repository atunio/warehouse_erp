                            ...
                            <table id="page-length-option1" class="bordered addproducttable" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    if (isset($id) && $id > 0) {
                                        ...
                                        $sum_value      = 0;
                                        $sql_ee1        = "SELECT a.* FROM sales_order_detail a WHERE a.sales_order_id = '" . $id . "' AND a.enabled=1 ";  //echo $sql_ee1;
                                        ...
                                        <tr class="dynamic-row" id="row_<?= $i; ?>" <?php echo $style; ?>>
                                            <td>
                                                <select <?php echo $disabled;
                                                        echo $readonly; ?> name="<?= $field_name ?>[]" id="<?= $field_id ?>" class="select2-theme browser-default select2-hidden-accessible product_stock <?= $field_name ?>_<?= $i ?>">
                                                    <option value="">Select a product</option>
                                                    <?php
                                                    if ($count1 > 0) {
                                                        $row1    = $db->fetch($result1);
                                                        foreach ($row1 as $data2) { ?>
                                                            <option value="<?php echo $data2['product_stock_id']; ?>" <?php if (isset($product_stock_ids[$i - 1]) && $product_stock_ids[$i - 1] == $data2['product_stock_id']) {
                                                                                                                            echo 'selected="selected"';
                                                                                                                        } ?>><?php echo $data2['product_desc']; ?> (<?php echo $data2['category_name']; ?>) - <?php echo $data2['product_uniqueid']; ?>, Serial#: - <?php echo $data2['serial_no']; ?>, Purchase Price: - <?php echo $data2['price']; ?> </option>
                                                    <?php }
                                                    } ?>
                                                </select>
                                            </td>
                                            <td>
                                                ...
                                                <textarea <?php echo $disabled;
                                                            echo $readonly; ?> id="<?= $field_name; ?>" name="<?= $field_name; ?>[]" class="materialize-textarea validate "><?php if (isset($product_so_desc[$i - 1])) {
            ...
            <div class="card-panel">
                <div class="row">
                    ...
                    <div class="col m9 s12">
                        <div class="text_align_right">
                            <?php
                            $table_columns    = array('S_No', 'Product ID', 'Detail', 'Qty');
                            $k                 = 0;
                            foreach ($table_columns as $data_c1) { ?>
                                <label>
                                    <input type="checkbox" value="<?= $k ?>" name="table_columns[]" class="filled-in toggle-column" data-column="<?= set_table_headings($data_c1) ?>" checked="checked">
