                ...
                <div class="row">
                    ...
                    <div class=" col m1 s12">
                        ...
                        <?php if (isset($id) && $id > 0 && (($cmd6 == 'add' || $cmd6 == '') && access("add_perm") == 1)  || ($cmd6 == 'edit' && access("edit_perm") == 1) || ($cmd6 == 'delete' && access("delete_perm") == 1)) { ?>
                            <button class=" mb-6 btn waves-effect waves-light gradient-45deg-purple-deep-orange" type="submit" name="add">Add</button>
                        <?php } ?>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="input-field col m2 s12">
                        <?php if ((access("add_perm") == 1)  || (access("edit_perm") == 1)) { ?>
                            <button class="mb-6 btn waves-effect waves-light gradient-45deg-purple-deep-orange" type="submit" name="add">Update Box Dimentions</button>
                        <?php } ?>
                    </div>
                    <div class="col m5 s12"></div>
                </div>
                ...
                <form id="barcodeForm2" class="infovalidate" action="?string=<?php echo encrypt("module=" . $module . "&module_id=" . $module_id . "&page=profile&cmd=edit&id=" . $id . "&active_tab=tab3") ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class=" col m2 s12"><br>
                            <?php if (isset($id) && $id > 0 && (($cmd6 == 'add' || $cmd6 == '') && access("add_perm") == 1)  || ($cmd6 == 'edit' && access("edit_perm") == 1) || ($cmd6 == 'delete' && access("delete_perm") == 1)) { ?>
                                <button class="mb-6 btn waves-effect waves-light gradient-45deg-purple-deep-orange" type="submit" name="add">Add Bulk Packing</button>
                            <?php } ?>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class=" col m3 s12 "><br>
                        <?php if (isset($id) && $id > 0 &&  access("delete_perm") == 1) { ?>
                            <button class="mb-6 btn waves-effect waves-light gradient-45deg-purple-deep-orange" type="submit" name="deletepserial">Unpack / Remove from Packing</button>
                        <?php } ?>
                    </div>
