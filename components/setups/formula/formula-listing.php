...
if (isset($cmd) && ($cmd == 'disabled' || $cmd == 'enabled') && access("delete_perm") == 0) {
	...
	if (isset($cmd) && $cmd == 'disabled') {
		$sql_c_upd = "UPDATE formula_category set enabled = 0,
	...
	if (isset($cmd) && $cmd == 'enabled') {
		$sql_c_upd = "UPDATE formula_category set 	enabled 	= 1,
											update_date = '" . $add_date . "' ,
											update_by 	= '" . $_SESSION['username'] . "' ,
											update_ip 	= '" . $add_ip . "'
					WHERE id = '" . $id . "' ";
											...
											<thead>
												<tr>
													...
													$headings = '<th class="sno_width_60">S.No</th>
																<th>Formula Type</th>
																<th>Category</th>
																<th>No of Devices Per User Per Day</th>
																<th>Action</th>';
													echo $headings;
													?>
												</tr>
												...
												if ($count_cl > 0) {
													...
													foreach ($row_cl as $data) {
														...
														<tr>
															...
															<td><?php echo $data['formula_type']; ?></td>
															<td><?php echo $data['category_name']; ?></td>
															<td><?php echo $data['devices_per_user_per_day']; ?></td>
