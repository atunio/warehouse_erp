...
if (isset($cmd) && $cmd == 'delete') {
	...
	if ($count_check == 0) {
		$sql_ee2 	= " UPDATE super_admin_roles SET enabled = 0 WHERE id = '" . $id . "' ";
...
if (empty($error)) {
	$sql_cl = "	SELECT a.* FROM super_admin_roles a WHERE a.enabled	= 1 AND a.role_name	!= 'Super Admin' "; // AND a.role_name	!= 'Super Admin'
...
//}
$page_heading = "Create Role or Set Permissions For Sub Super Admin "; ?>
<!-- BEGIN: Page Main-->
