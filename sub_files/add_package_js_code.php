<script>
    $(document).on('click', '#add_package_btn', function(e) {
        ...
        var dataString = 'type=add_package&package_name=' + package_name + '&product_id=' + inquiry_id_modal + '&product_category=' + product_category + '&cmd=' + cmd + '&id=' + id + '&module_id=' + module_id;
        $.ajax({
            type: "POST",
