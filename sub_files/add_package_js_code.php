<script>
    $(document).on('click', '#add_package_btn', function(e) {
        ...
        var product_id_modal = $("#product_id_pkg_modal option:selected").val();
        var id = $("#id").val();
        var module_id = $("#module_id").val();
        var dataString = 'type=add_package&package_name=' + package_name + '&sku_code=' + sku_code + '&case_pack=' + case_pack + '&pack_desc=' + pack_desc + '&product_id=' + product_id_modal + '&product_category=' + product_category + '&id=' + id + '&module_id=' + module_id;
        $.ajax({
            type: "POST",
