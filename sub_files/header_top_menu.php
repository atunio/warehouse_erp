                ...
                <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
                    ...
                    foreach ($row_2_top_menu as $data_top_menu) {
                        ...
                        if ($check_menu_permissions > 0) {
                            ...
                            <?php } else { ?>
                                <li>
                                    <a class="dropdown-menu" href="Javascript:void(0)" data-target="vmenu<?php echo $module_id_sitebar; ?>">
                                        <i class="material-icons"><?php echo $icon_name; ?></i>
                                        <span>
                                    ...
                                    <ul class="dropdown-content dropdown-horizontal-list" id="vmenu<?php echo $module_id_sitebar; ?>">
                                        <?php
                                                ...
                                                if ($check_menu_permissions > 0) {
                                                    ...
                                                    <?php
                                                        ...
                                                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                                            <a class="dropdownSub-menu" href="Javascript:void(0)" data-target="vmenu<?php echo $module_id_sitebar; ?>">
                                                                <span>
                                                                    <span class="dropdown-title custom_sytel_menu_link" data-i18n="<?php echo $menu_name; ?>"><?php echo $menu_name; ?></span>
    ...
    <?php }
        ...
        <li data-menu="">
            <a href="javascript:void(0)">
                <span><b><?php echo $module_folder; ?>/<?php echo $module; ?>/<?php echo $page; ?></b></span>
            </a>
        </li>
    <?php } ?>
    </ul>
